    ...
    <div class="flex h-screen">
       ...
       <div class="main-content flex-1 flex flex-col overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto mt-10 bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Tambah Fasilitas Baru</h2>
                
                <form action="tambah-fasilitas.php" method="POST" class="space-y-6">

                    <div>
                        <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">Nama Fasilitas</label>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Masukkan deskripsi/keterangan fasilitas" 
...
if(isset($_POST['submit'])){
    ...
    $qwy = mysqli_query($koneksi,"INSERT INTO fasilitas(nama_fasilitas,keterangan) VALUES('$nama_fasilitas','$keterangan')");

    if($qwy){
         echo "
                    <script>
                        alert('BERHASIL menambahkan data fasilitas');
                    </script>
                    ";
    }else{
         echo "
